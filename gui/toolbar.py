...
import gui.menu_bar as menu
import data_visualization.filters as filters
...
def create_toolbar(main_window):
    ...
    toolbar.addAction(QIcon("gui/static/open.svg"), "Open File",lambda: menu.file_dialog(main_window))
